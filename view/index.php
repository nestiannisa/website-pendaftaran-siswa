            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Dashboard Pendaftaran Siswa</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard</li>
                        </ol>
                        <div class="card mx-auto bg-light mb-3 " style="max-width: 50rem; margin-top:175px;">
                        <div class="card-body">
                        <h2 class=" text-center">SELAMAT DATANG DI </h2>
                        <h2 class=" text-center">SISTEM PENDAFTARAN SISWA</h2>
                        </div>
                        </div>
                    </div>
                </main>
